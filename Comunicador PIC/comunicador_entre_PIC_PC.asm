...
;comunicador_entre_PIC_PC.c,46 :: 		void setTime(sfr unsigned short volatile *timer, double tempo_seg, double frequencia)
...
;comunicador_entre_PIC_PC.c,50 :: 		int Tmof = (int)(tempo_seg/(256*frequencia/4));
	MOVLW       0
	MOVWF       R0 
	MOVLW       0
	MOVWF       R1 
...
;comunicador_entre_PIC_PC.c,51 :: 		for(postscaler = 3; postscaler > 0; postscaler--)
	MOVLW       3
	MOVWF       setTime_postscaler_L0+0 
	MOVLW       0
	MOVWF       setTime_postscaler_L0+1 
...
L__setTime34:
	BTFSC       STATUS+0, 0 
	GOTO        L_setTime1
;comunicador_entre_PIC_PC.c,53 :: 		for(prescaler = 16; prescaler > 0; prescaler--)
	MOVLW       16
	MOVWF       setTime_prescaler_L0+0 
	MOVLW       0
	MOVWF       setTime_prescaler_L0+1 
...
L__setTime35:
	BTFSC       STATUS+0, 0 
	GOTO        L_setTime4
;comunicador_entre_PIC_PC.c,55 :: 		if(Tmof%(prescaler*postscaler) == 0) goto LABEL;
	MOVF        setTime_prescaler_L0+0, 0 
	MOVWF       R0 
...
;comunicador_entre_PIC_PC.c,57 :: 		}
	GOTO        L_setTime0
L_setTime1:
;comunicador_entre_PIC_PC.c,58 :: 		LABEL:
___setTime_LABEL:
;comunicador_entre_PIC_PC.c,59 :: 		if(timer == &TMR6) //estou mexendo comm o Timer6?
...
L__setTime37:
	BTFSS       STATUS+0, 2 
	GOTO        L_setTime7
;comunicador_entre_PIC_PC.c,61 :: 		T6CON = 0x00;
	CLRF        T6CON+0 
;comunicador_entre_PIC_PC.c,62 :: 		T6CON = prescaler <<  6;
	MOVLW       6
	MOVWF       R1 
	MOVF        setTime_prescaler_L0+0, 0 
	MOVWF       R0 
...
L__setTime39:
	MOVF        R0, 0 
	MOVWF       T6CON+0 
;comunicador_entre_PIC_PC.c,63 :: 		T6CON += postscaler;
	MOVF        setTime_postscaler_L0+0, 0 
	ADDWF       T6CON+0, 1 
;comunicador_entre_PIC_PC.c,64 :: 		TMR6 = 0;
	CLRF        TMR6+0 
;comunicador_entre_PIC_PC.c,65 :: 		timer6timer = Tmof / (prescaler + postscaler);
	MOVF        setTime_postscaler_L0+0, 0 
...
;comunicador_entre_PIC_PC.c,66 :: 		return ;
	GOTO        L_end_setTime
;comunicador_entre_PIC_PC.c,67 :: 		}
L_setTime7:
